...
data class DistrictWise (
    ...
    @SerializedName("field") var field : List<DField>,
    ...
    @SerializedName("target_bucket") var targetBucket : DTargetBucket,
    ...
    @SerializedName("records") var records : List<DRecords>
